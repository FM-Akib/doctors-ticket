...
const Login = () => {
	...
	<form onSubmit={handleLoginForm}  action="" className="space-y-8">
		...
		<button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-rose-600 text-gray-50">Sign in</button>
	</form>
</div>
